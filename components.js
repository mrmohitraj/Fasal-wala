/* ===================================================================
   MR FASAL WALA — SHARED COMPONENTS
...
function headerHTML(){
  ...
  <header class="site-header" id="siteHeader">
    <div class="header-inner">
      ...
      <a href="index.html" class="logo"><span class="logo-icon">🌾</span><span class="hide-sm">Mr Fasal Wala</span></a>
    ...
    <div class="container">
      <div class="footer-grid">
        <div class="footer-col">
          <h4>Mr Fasal Wala</h4>
          <ul>
            <li>India's dedicated marketplace for crops & crop waste.</li>
          </ul>
      ...
      <div class="footer-bottom">© ${new Date().getFullYear()} Mr Fasal Wala. All rights reserved.</div>
    </div>
  </footer>
